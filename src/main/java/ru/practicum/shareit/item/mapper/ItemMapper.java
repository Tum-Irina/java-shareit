...
public class ItemMapper {
    ...
    public static Item toItemUpdate(ItemDto itemDto, Item existingItem) {
        Item item = new Item();
        ...
        item.setRequestId(itemDto.getRequestId() != null ? itemDto.getRequestId() : existingItem.getRequestId());
        return item;
    }
}